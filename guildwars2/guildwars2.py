...
class Guildwars2:
	...
	async def search(self, ctx, *, item):
		...
		for item in bank if item != None and item["id"] == shiniesresults[num]["item_id"]
		...
		materialresults = [item["count"] for item in material if item != None and item["id"] == shiniesresults[num]["item_id"]]
